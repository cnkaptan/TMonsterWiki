...
class TagsAdapter(val context: Context, val tags: List<TagEntity>, val listener: (TagEntity)-> Unit): RecyclerView.Adapter<TagsAdapter.TagsViewHolder>(){
    ...
    override fun onBindViewHolder(holder: TagsViewHolder, position: Int) {
        ...
        val drawableId = context.resources.getIdentifier(
                tagEntity.resourceCode.toLowerCase(),

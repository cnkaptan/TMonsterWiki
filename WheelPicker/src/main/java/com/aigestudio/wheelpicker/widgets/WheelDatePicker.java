...
public class WheelDatePicker extends LinearLayout implements WheelPicker.OnItemSelectedListener,
    ...
    public void setFormat(String languageCode,String countryCode,String dateFormat){
        final Locale locale;
        if(languageCode==null)locale=Locale.getDefault();
        else if(countryCode==null)locale=new Locale(languageCode);
        else locale=new Locale(languageCode,countryCode);
        SDF=new SimpleDateFormat(dateFormat!=null?dateFormat:SDF.toPattern(),locale);
        invalidate();
    }
    ...
    public WheelDatePicker(Context context, AttributeSet attrs) {
        ...
        mPickerYear.setMaximumWidthText("00000");
        mPickerMonth.setMaximumWidthText("000000000");
        mPickerDay.setMaximumWidthText("00000");
        ...
        if(attrs!=null){
            TypedArray array=context.obtainStyledAttributes(attrs,R.styleable.WheelDatePicker);
            setFormat(
                    array.getString(R.styleable.WheelDatePicker_wheel_language_code),
                    array.getString(R.styleable.WheelDatePicker_wheel_country_code),
                    array.getString(R.styleable.WheelDatePicker_wheel_date_format)
            );
            array.recycle();
        }
    }
    ...
    public void setYearFrame(int start, int end, boolean animate) {
        mPickerYear.setYearFrame(start, end, animate);
    }
    ...
    public void setSelectedDay(int day, boolean animate) {
        mDay = day;
        mPickerDay.setSelectedDay(day, animate);
    }
    ...
    public void setYearAndMonth(int year, int month, boolean animate) {
        mYear = year;
        mMonth = month;
        mPickerYear.setSelectedYear(year, animate);
        mPickerMonth.setSelectedMonth(month, animate);
        mPickerDay.setYearAndMonth(year, month);
    }
    ...
    public int getMinFlingY() {
        return mPickerYear.getMinFlingY();
    }

    public void setMinFlingY(int mMinFlingY) {
        mPickerYear.setMinFlingY(mMinFlingY);
        mPickerDay.setMinFlingY(mMinFlingY);
        mPickerMonth.setMinFlingY(mMinFlingY);
    }

    public int getMaxFlingY() {
        return mPickerYear.getMaxFlingY();
    }

    public void setMaxFlingY(int mMaxFlingY) {

        mPickerYear.setMaxFlingY(mMaxFlingY);
        mPickerDay.setMaxFlingY(mMaxFlingY);
        mPickerMonth.setMaxFlingY(mMaxFlingY);
    }

    public int getMinimumVelocity() {
        return mPickerYear.getMinimumVelocity();
    }

    public void setMinimumVelocity(int mMinimumVelocity) {
        mPickerYear.setMinimumVelocity(mMinimumVelocity);
        mPickerDay.setMinimumVelocity(mMinimumVelocity);
        mPickerMonth.setMinimumVelocity(mMinimumVelocity);
    }

    public int getMaximumVelocity() {
        return mPickerYear.getMaximumVelocity();
    }

    public void setMaximumVelocity(int mMaximumVelocity) {

        mPickerYear.setMaximumVelocity(mMaximumVelocity);
        mPickerDay.setMaximumVelocity(mMaximumVelocity);
        mPickerMonth.setMaximumVelocity(mMaximumVelocity);
    }

    public int getTouchSlop() {
        return mPickerYear.getTouchSlop();
    }

    public void setTouchSlop(int mTouchSlop) {
        mPickerYear.setTouchSlop(mTouchSlop);
        mPickerDay.setTouchSlop(mTouchSlop);
        mPickerMonth.setTouchSlop(mTouchSlop);
    }
}